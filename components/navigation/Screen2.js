...
class Screen2 extends Component {
    static navigationOptions = ({ navigation, navigationOptions }) => { // use function to extract navigation, navigationOptions, screenProps
        const title = 'This is Screen2' + ((navigation.getParam('counter', 0) > 0) ? ' again' : '');
        return {
            title: title, 
            headerStyle: { backgroundColor: navigationOptions.headerTintColor }, // override default with another value from parent navigationOptions
